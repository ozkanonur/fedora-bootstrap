...
# necessary tools
dnf -y install xrandr xcompmgr xset xcompmgr NetworkManager-tui tlp tlp-rdw brightnessctl pulseaudio-utils valgrind freerdp flameshot feh setxkbmap openvpn
